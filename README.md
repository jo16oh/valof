...
The severity is what the [plugin](#plugin-for-eslint-and-oxlint) sets, and a project can give any
rule its own. The [command](#cli) draws every finding the same way and exits 1 on any of them.
